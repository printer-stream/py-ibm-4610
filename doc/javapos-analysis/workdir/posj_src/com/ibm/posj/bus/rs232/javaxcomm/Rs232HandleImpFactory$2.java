...
class Rs232HandleImpFactory$2 extends DefaultRs232PortListener {
   Rs232HandleImpFactory$2(Rs232HandleImpFactory this$0, ByteBuffer val$buffer) {
      this.this$0 = this$0;
      this.val$buffer = val$buffer;
   }

   public void dataEventOccurred(Rs232DataEvent rs232DataEvent) {
      this.val$buffer.append((byte)0);
      this.val$buffer.append((byte)0);
