...
class Rs485HandlePopulator$5 implements SioDeviceListener {
   Rs485HandlePopulator$5(Rs485HandlePopulator this$0, ByteBuffer val$buffer, ScannerDetectState val$state) {
      this.this$0 = this$0;
   ...
   public void statusEventOccurred(SioDeviceStatusEvent event) {
      this.this$0.println("status Event occurred");
