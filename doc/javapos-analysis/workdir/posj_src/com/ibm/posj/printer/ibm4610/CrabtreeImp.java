...
public class CrabtreeImp extends IBM4610Imp {
   public CrabtreeImp(PrinterWriter mainWriter, DefaultPOSPrinterHandle handle, LogHelper logger) {
      super(mainWriter, handle, logger);
   }

   protected PrinterHandleState createPrinterHandleState() {
      return new CrabtreeImp.CrabtreeState(this.logger, this.getHandle());
   }
